 ...
 */
class DynamicContextMenuManager {

    private val bundle = FrameworkUtil.getBundle(DynamicContextMenuManager::class.java)
    ...
    companion object {
        private var instance: DynamicContextMenuManager? = null

        fun getInstance(): DynamicContextMenuManager {
            if (instance == null) {
                instance = DynamicContextMenuManager()
            }
            return instance!!
        }
    }
     ...
     */
    fun getContextMenuActions(): List<org.eclipse.jface.action.IAction> {
        val contextMenuProvider = getContextMenuProvider(getCurrentExtensionId())
        // TODO: Pass the correct context/project object.
        return contextMenuProvider?.getContextMenuActions(null) ?: emptyList()
    }
    ...
    private fun refreshContextMenus() {
        // TODO: Implement UI refresh in Eclipse.
        logger.info("UI refresh requested for extension: $currentExtensionId")
    }
